...
\caption{\label{fig:histo_dcm_Nber} Histogrammes cliniques de la tumeur de \Nber. }
\end{figure}

\FloatBarrier
\subsection{Histogrammes cliniques de \Chen}
Ci-dessous est présenté l'ensemble des histogrammes cliniques de \Chen, correspondant au niveaux de gris des régions contourées sur les scanners (\cf Figure~\ref{fig:contourageChen}).\vspace{-10mm}
...
\caption{\label{fig:histo_dcm_Chen} Histogrammes cliniques de la tumeur de \Chen. }
\end{figure}
