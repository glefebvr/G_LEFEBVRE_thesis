...
Une tumeur est un ensemble de cellules de l'organisme se multipliant de manière dégénérée\footnote{%Par dégénérée, on entend : 
...
\begin{wrapfigure}[16]{r}{.3\textwidth} %%% L : Left flottant / l: left non flottant (pas de pagebreak)
\vspace{-7mm}
