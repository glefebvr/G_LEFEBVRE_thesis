...
\begin{figure}
\subfloat[\label{fig:TK}Les tyrosines kinases~: des messagers cellulaires]{\includegraphics[trim= 0mm 190mm 85mm 0mm, clip=true, width=.32\textwidth]{schema/voies_moleculaires.pdf}}\hfill
\subfloat[\label{fig:TKI}Mode d'action d'un inhibiteur de tyrosine kinase (X-mab)]{\includegraphics[trim= 0mm 195mm 85mm 0mm, clip=true, width=.32\textwidth]{schema/anticorps.pdf}}\hfill
\subfloat[\label{fig:RTKI}Mode d'action d'un inhibiteur de récepteurs à tyrosine kinase (X-inib)]{\includegraphics[trim= 0mm 195mm 85mm 0mm, clip=true, width=.32\textwidth]{schema/inhibiteur.pdf}}
\caption{\correction{Les tyrosines kinases et leurs inhibiteurs}\label{fig:voies_moleculaires}}
\end{figure}
...
gastro-intestinales non épithéliales\footnote{\correction{épithélium~: Tissus constitués de cellules étroitement juxtaposées (ou jointives), sans interposition de fibre ou de substance fondamentale. Ces tissus servent notamment de paroi entre deux milieux.}}. Elles ont une incidence de 9 à 14 cas par million de personnes par an (\cf~\cite{Nilsson2005}). 
...
la découverte de mutations actives du gène KIT\footnote{\correction{gène gouvernant la production des KIT-kinases (aussi appelées CD117), normalement impliquées uniquement dans la division des cellules souches. Une mutation de ce gène peut impliquer la production de KIT-kinases dans les cellules cancéreuses et ainsi contribuer à leur multiplication déraisonnée.}}, aussi bien que le rôle du PDGFR\footnote{un type particulier de récepteurs de facteurs de croissances. De l'anglais~: Platelet Derived Growth Factor Receptor.} et le développement thérapeutique qui en découle, ont révolutionné le traitement des GISTs.
...
\begin{figure}
\subfloat[Patient présentant une mutation génétique EXON 11\label{fig:patients_EXON_a}]{\includegraphics[width=.48\textwidth]{brio.png}}\hfill
\subfloat[Patient présentant une mutation génétique EXON 9\label{fig:patients_EXON_b}]{\includegraphics[width=.48\textwidth]{LAN.png}}
