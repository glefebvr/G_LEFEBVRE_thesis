...
%% http://onlinelibrary.wiley.com/doi/10.1002/ijc.29210/abstract?userIsAuthenticated=false&deniedAccessCustomisedMessage=
...
(GIST).
Ce type de cancer touche de 9 à 14 personnes sur un million par an~\cite{Nilsson2005}. Dans 25\% des cas, ce cancer migre vers le foie~\cite{dematteo2000}. 
...
\paragraph{}
Le suivi clinique des patients sous traitement est assuré par des scanners réguliers, réalisés généralement tous les deux mois. Ceux-ci constituent la seule et unique source d'informations cliniques dont nous disposons ici.  
A l'heure actuelle, pour mesurer l'efficacité d'un traitement, le corps médical utilise le critère RECIST\footnote{de l'anglais~: Response Evaluation Criteria In Solid Tumors}, qui consiste à ne retenir, des images médicales, que le diamètre de la plus large lésion. 
...
\paragraph{}
Dans un troisième chapitre, les aspects numériques seront abordés. En particulier, il a fallu faire face à une instabilité numérique que l'on présentera et à laquelle l'équipe n'avait jamais été confrontée avec les schémas classiques utilisés. %qu'elle utilisait. 
...
\paragraph{}
Dans le cinquième et dernier chapitre, nous chercherons un critère permettant de quantifier l'\hetero. \todo[noline]{Etat de l'art sur la construction de quantificateur de l'\hetero} Ce critère devra être applicable aussi bien aux données cliniques qu'aux résultats fournis par la simulation numérique. Et c'est ce qui fait ici l'originalité de la construction d'un tel critère. 
