...
\usepackage[english,francais,frenchb]{babel}
...
\usepackage{array}
%%% Ajout de descripteur de colonne
...
%%%%% Definition des metadonnees du fichier pdf
\usepackage[pdftex,
            pdfauthor={Guillaume LEFEBVRE},
            pdftitle={Modélisation et analyse de l'hétérogénéité tumorale lors de résistance aux traitements~: cas des métastases hépatiques de GIST},
            pdfsubject={Mathématiques appliquées à la cancérologie},
            pdfkeywords={modélisation, simulation numérique, cancer, croissance tumorale, hétérogénéité  tumorale, résistance aux traitements, EDPs},
            pdfinfo={Manuscrit de thèse de Guillaume LEFEBVRE},
            pdfdisplaydoctitle={true},
            linktocpage={true},
            linkcolor={blue},
            linkbordercolor={0 0 1},
            hyperfootnotes={false}]{hyperref} %%% Les premieres compilations fournisse une erreur. recompiler plsrs fois ...
...
\usepackage[bottom]{footmisc} %%% force les footnotes sur la meme page que le footnotemark et donne la commande \footref (pour faire reference plusieurs fois a une meme note de bas de page)
...
%\newcommand{\correction}[1]{{\color{blue}#1}} %%% pour voir les corrections en bleu
\newcommand{\correction}[1]{#1} %%%% pour le final
...
%\newcommand{\titreen}{Tumor heterogeneity modeling and analysis, during  treatments resistance: case of GIST liver metastases}
\newcommand{\titreen}{Modeling and analysis of tumor heterogeneity during  treatments resistance: case of GIST liver metastases}
